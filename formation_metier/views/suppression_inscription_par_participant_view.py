...
class SuppressionInscriptionParParticipant(LoginRequiredMixin, PermissionRequiredMixin, SuccessMessageMixin,
                                           DeleteView):
    permission_required = ['formation_metier.suppression_inscription_par_participant',
    ...
    def get_queryset(self):
        ...
        inscription = Inscription.objects.get(participant=self.request.user.employeuclouvain,
